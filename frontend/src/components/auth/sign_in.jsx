...
function SignIn() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (message.toLowerCase().includes("credentials") || message.toLowerCase().includes("password") || message.toLowerCase().includes("incorrect")) {
        ...
        <div className="w-full h-full flex flex-col bg-light-card1 dark:bg-[#0c0c0e]/80 border border-light-border dark:border-white/5 rounded-[3rem] p-12 shadow-2xl relative z-10 overflow-hidden backdrop-blur-xl">
          ...
          <div className="relative z-10 pl-2">
            <h2 className="text-3xl lg:text-4xl font-black leading-tight tracking-tight mb-3">
              Unlock Your <br />{" "}
              <span className="text-button-primary">Design Potential</span>
            </h2>
          ...
          <div className="flex justify-between items-center px-1">
            <label className="flex items-center gap-2 cursor-pointer group/cb">
              <div className="relative flex items-center justify-center">
                <input
                  type="checkbox"
                  className="appearance-none w-4 h-4 rounded border border-light-border dark:border-white/20 bg-white dark:bg-[#14151a] checked:bg-button-primary checked:border-button-primary transition-colors cursor-pointer"
                />
                <svg
                  className="absolute w-3 h-3 text-white opacity-0 pointer-events-none check-icon"
                  viewBox="0 0 14 14"
                  fill="none"
                >
                  <path
              ...
              <span className="text-sm font-medium text-light-text2 dark:text-gray-400 group-hover/cb:text-light-text1 dark:group-hover/cb:text-white transition-colors">
                Remember me
              </span>
            </label>
