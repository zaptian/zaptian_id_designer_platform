...
import { Mail, Lock, Eye, EyeOff, ArrowLeft, ArrowRight, User, Phone } from "lucide-react"
        ...
        <div className="w-full h-full flex flex-col bg-light-card1 dark:bg-[#0c0c0e]/80 border border-light-border dark:border-white/5 rounded-[3rem] p-12 shadow-2xl relative z-10 overflow-hidden backdrop-blur-xl">
          ...
          <div className="relative z-10 pl-2">
            <h2 className="text-3xl lg:text-4xl font-black leading-tight tracking-tight mb-3">
              Design, Print, Verify <br/> <span className="text-button-primary">Effortlessly</span>
            </h2>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4">
        <div className="w-full max-w-[460px] flex flex-col gap-6 animate-slideUp">
          ...
          <div className="flex flex-col gap-5">
             ...
             <div className="flex flex-col sm:flex-row gap-5">
               <div className="flex-1 flex flex-col gap-2">
                 ...
                 {errors.firstName && <p className="text-xs text-red-500 font-semibold ml-1">{errors.firstName}</p>}
               </div>
               ...
               <div className="flex-1 flex flex-col gap-2">
                 ...
                 {errors.lastName && <p className="text-xs text-red-500 font-semibold ml-1">{errors.lastName}</p>}
               </div>
             </div>
             ...
             <div className="flex flex-col gap-2">
               ...
               {errors.mobile && <p className="text-xs text-red-500 font-semibold ml-1">{errors.mobile}</p>}
             </div>

             {/* Password */}
             <div className="flex flex-col gap-2">
               <label className="text-sm font-bold text-light-text1 dark:text-gray-300 ml-1">Create Password</label>
               <div className="relative group/input">
                 <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 group-focus-within/input:text-button-primary transition-colors">
                    <Lock size={18} />
                 </div>
             ...
             {/* Confirm Password */}
             <div className="flex flex-col gap-2">
               <label className="text-sm font-bold text-light-text1 dark:text-gray-300 ml-1">Confirm Password</label>
               <div className="relative group/input">
                 <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 group-focus-within/input:text-button-primary transition-colors">
                    <Lock size={18} />
                 </div>
               ...
               {errors.confirmPassword && <p className="text-xs text-red-500 font-semibold ml-1">{errors.confirmPassword}</p>}
             </div>
          </div>
          ...
          <div className="flex flex-col px-1 pt-2">
            <label className="flex items-start gap-3 cursor-pointer group/cb">
               <div className="relative flex items-center justify-center mt-0.5 shrink-0">
                  ...
                  />
                  <svg className="absolute w-3.5 h-3.5 text-white opacity-0 pointer-events-none check-icon" viewBox="0 0 14 14" fill="none"><path d="M3 8L6 11L11 3.5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" stroke="currentColor"></path></svg>
               </div>
               <span className="text-sm font-medium text-light-text2 dark:text-gray-400 leading-snug">
                 I agree to the{" "}
                 <span className="text-button-primary font-bold hover:underline">Terms & Conditions</span>
                 {" "}and{" "}
                 <span className="text-button-primary font-bold hover:underline">Privacy Policy</span>
               </span>
            </label>
            {errors.agreeTerms && <p className="text-xs text-red-500 font-semibold ml-8 mt-1">{errors.agreeTerms}</p>}
          </div>
          ...
          <div className="flex items-center gap-4 my-2">
            ...
            <span className="text-xs font-bold text-light-text2 dark:text-gray-500 uppercase tracking-wider">or register with</span>
            <div className="flex-1 h-px bg-light-border dark:bg-white/10" />
          </div>
